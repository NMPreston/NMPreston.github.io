...
Conducted patentability searches and drafted comprehensive reports evaluating inventions against U.S. and international prior art. Gained direct exposure to the patent lifecycle from conception to filing through hands-on USPTO prosecution work.
...
Founded and operated an e-commerce apparel brand, overseeing logo and product design, inventory management, and order fulfillment with a 99% on-time rate.
...
- **Programming for Everybody (Getting Started with Python)** — University of Michigan / Coursera *(September 2021)*
...
**Technical:** Algorithm Design, Deep Learning, Cybersecurity Fundamentals, Python, C++, Kali Linux, Edge Computing, Network Security  
